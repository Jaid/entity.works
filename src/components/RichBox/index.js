...
export default class RichBox extends React.Component {
  ...
  render() {
    if (this.props.type === "survivor") {
      ...
      return <SurvivorBox className={this.props.className} survivor={id} tooltip={this.props.tooltips}/>
    }
    if (this.props.type === "killer") {
      const id = this.props.name || this.props.info.id
      return <KillerBox className={this.props.className} killer={id} tooltip={this.props.tooltips}/>
    }
    if (this.props.type === "perk") {
      const id = this.props.name || this.props.info.id
      return <PerkBox className={this.props.className} perk={id} tooltip={this.props.tooltips}/>
    }
  }
